...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.graphWidget.setTitle("<span style=\"color:green;font-size:15px\">Fitness vs Generations</span>")
        self.graphWidget.setLabel('left', 'Fitness', color='white', size=10)
        self.graphWidget.setLabel('bottom', 'Generations', color='white', size=10)
